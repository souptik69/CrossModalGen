...
class AV_VQVAE_Encoder(nn.Module):
    def __init__(self, audio_dim, video_dim,  video_output_dim, n_embeddings, embedding_dim, ablation=None):
...
class AVT_VQVAE_Encoder(nn.Module):
    def __init__(self, audio_dim, video_dim, text_dim,  video_output_dim, n_embeddings, embedding_dim, ablation=None):
...
class Cross_VQEmbeddingEMA_AV_hierarchical_ALignEMA(nn.Module):
    def __init__(self, n_embeddings, embedding_dim, commitment_cost=0.25, decay=0.99, epsilon=1e-5):
        super(Cross_VQEmbeddingEMA_AV_hierarchical_ALignEMA, self).__init__()
        self.commitment_cost = commitment_cost
        self.decay = decay
        self.epsilon = epsilon
...
class Cross_VQEmbeddingEMA_AV_hierarchical_HIER(nn.Module):
    def __init__(self, n_embeddings, embedding_dim, commitment_cost=0.25, decay=0.99, epsilon=1e-5):
        super(Cross_VQEmbeddingEMA_AV_hierarchical_HIER, self).__init__()
        self.commitment_cost = commitment_cost
        self.decay = decay
        self.epsilon = epsilon
...
class Cross_VQEmbeddingEMA_AV_hierarchical_Reset(nn.Module):
    def __init__(self, n_embeddings, embedding_dim, commitment_cost=0.25, decay=0.99, epsilon=1e-5):
        super(Cross_VQEmbeddingEMA_AV_hierarchical_Reset, self).__init__()
        self.commitment_cost = commitment_cost
        self.decay = decay
        self.epsilon = epsilon
...
class Cross_VQEmbeddingEMA_AVT_hierarchical_ALignEMA(nn.Module):
    def __init__(self, n_embeddings, embedding_dim, commitment_cost=0.25, decay=0.99, epsilon=1e-5):
        super(Cross_VQEmbeddingEMA_AVT_hierarchical_ALignEMA, self).__init__()
        self.commitment_cost = commitment_cost
        self.decay = decay
        self.epsilon = epsilon
...
class Cross_VQEmbeddingEMA_AVT_hierarchical_HIER(nn.Module):
    def __init__(self, n_embeddings, embedding_dim, commitment_cost=0.25, decay=0.99, epsilon=1e-5):
        super(Cross_VQEmbeddingEMA_AVT_hierarchical_HIER, self).__init__()
        self.commitment_cost = commitment_cost
        self.decay = decay
        self.epsilon = epsilon
...
class Cross_VQEmbeddingEMA_AVT_hierarchical_Reset(nn.Module):
    def __init__(self, n_embeddings, embedding_dim, commitment_cost=0.25, decay=0.99, epsilon=1e-5):
        super(Cross_VQEmbeddingEMA_AVT_hierarchical_Reset, self).__init__()
        self.commitment_cost = commitment_cost
        self.decay = decay
        self.epsilon = epsilon
