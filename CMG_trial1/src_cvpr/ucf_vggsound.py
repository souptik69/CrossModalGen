...
def main():
    ...
    if args.dataset_name == 'ucfv_vgga':
        train_csv_path = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/UCF101/data/ucf2vggsound.csv'
        ...
        train_csv_path = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/UCF101/data/vggsound2ucf.csv'
        val_csv_path = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/UCF101/data/ucf2vggsound.csv'
        audio_fea_base_path = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/vggsound40k/feature/audio/zip'
        video_fea_base_path = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/UCF101/feature/video/zip'
