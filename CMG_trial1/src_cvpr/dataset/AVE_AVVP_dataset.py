...
class AVEDataset(Dataset):
    def __init__(self, data_root, split='train'):
        ...
        self.split = split
        feature_root = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/AVE/data'
...
def generate_category_list():
    file_path = '/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/AVE_AVVP/AVE_AVVP_Categories.txt'
    category_list = []
