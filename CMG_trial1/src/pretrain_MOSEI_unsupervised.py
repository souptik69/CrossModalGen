...
def main():
    ...
    if model_resume is True:
        path_checkpoints = "/project/ag-jafra/Souptik/CMG_New/Experiments/CMG_trial1/MOSEI_Models_3/Final_MOSEI_unsupervised_VAT_30dim__NewAttention_window_laststep/checkpoint/MOSEI-model-unsupervised-29.pt"
...
def train_epoch(CPC,Encoder, Decoder,train_dataloader, optimizer, epoch, total_step, args):
    ...
    for n_iter, batch_data in enumerate(train_dataloader):
        ...
        # VGG downstream
        # loss =  audio_recon_loss + video_recon_loss + text_recon_loss + audio_embedding_loss +  video_embedding_loss + text_embedding_loss + cmcm_loss + cpc_loss + nce_loss_1
