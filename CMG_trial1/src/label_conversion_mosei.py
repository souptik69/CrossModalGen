...
def discrete_to_continuous_sentiment(discrete_labels):
    ...
    class_midpoints = torch.tensor([-3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0], 
...
def predictions_to_continuous(class_predictions):
    ...
    class_values = torch.tensor([-3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0], 
...
def get_boundary_info():
    ...
    return {
        'ranges': {
            0: {'range': '[-3.0, -2.5)', 'label': 'Highly Negative', 'midpoint': -3.0},
            ...
            6: {'range': '[2.5, 3.0]', 'label': 'Highly Positive', 'midpoint': 3.0}
        },
        'midpoints': [-3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0]
    }
