...
class VGGSoundDataset_AT(Dataset):
    ...
    def __init__(self, meta_csv_path, audio_fea_base_path, split='train'):
        ...
        self.label2prompt = pd.read_csv('/project/ag-jafra/Souptik/VGGSoundAVEL/Data/vggsoundCategories2Prompts.csv')
        self.audio_fea_base_path = audio_fea_base_path
        all_df = pd.read_csv(meta_csv_path)
        ...
        self.all_categories = generate_category_list()
        print(f'total {len(self.all_categories)} classes in Vggsound100K_AT')
...
#         # self.label2prompt = pd.read_csv('/project/ag-jafra/Souptik/VGGSoundAVEL/Data/vggprompts.csv')
#         self.label2prompt = pd.read_csv('/project/ag-jafra/Souptik/VGGSoundAVEL/Data/vggsoundCategories2Prompts.csv')
#         # self.label2prompt = pd.read_csv('/project/ag-jafra/Souptik/VGGSoundAVEL/Data/vggprompts_limited_1.csv')
#         self.audio_fea_base_path = audio_fea_base_path
#         self.video_fea_base_path = video_fea_base_path
#         all_df = pd.read_csv(meta_csv_path)
...
#         matching_prompts = self.label2prompt.loc[self.label2prompt['label'] == category]['prompt'].values
#         text_fea = random.choice(matching_prompts)
...
class VGGSoundDataset_AVT(Dataset):
    def __init__(self, meta_csv_path, audio_fea_base_path, video_fea_base_path, split='train'):
        super(VGGSoundDataset_AVT, self).__init__()
        self.label2prompt = pd.read_csv('/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/vggsound40k/data/vggsoundCategories2Prompts.csv')
        self.audio_fea_base_path = audio_fea_base_path
        self.video_fea_base_path = video_fea_base_path
        all_df = pd.read_csv(meta_csv_path)
...
class VGGSoundDataset_AVT_new(Dataset):
    def __init__(self, meta_csv_path, audio_fea_base_path, video_fea_base_path, avc_label_base_path, split='train'):
        super(VGGSoundDataset_AVT_new, self).__init__()
        self.label2prompt = pd.read_csv('/project/ag-jafra/Souptik/VGGSoundAVEL/Data_CMG/CMG/data/data/vggsound40k/data/vggsoundCategories2Prompts.csv')
        self.audio_fea_base_path = audio_fea_base_path
        self.video_fea_base_path = video_fea_base_path
        self.avc_label_base_path = avc_label_base_path
    ...
    def __getitem__(self, index):
        ...
        sample = {'video_fea': video_fea, 'audio_fea': audio_fea, 'text_fea': text_fea, 'avel_label': avel_label}
        return sample
